...
import com.davide.webapp.security.JwtTokenUtil;
...
public class JwtAuthenticationRestController 
{
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody @Validated JwtTokenRequest authenticationRequest)
